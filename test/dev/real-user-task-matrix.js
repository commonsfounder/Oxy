...
const TASKS = [
  ...
  { id: 'scheduled-tasks', group: 'household-read', mode: 'safe', expectedAction: 'list_scheduled_tasks', message: 'What is Adam currently watching or scheduled to do?' },
  ...
  { id: 'adam-business-email', group: 'approval', mode: 'approval', expectedAction: 'send_adam_email', message: 'Email the restaurant and ask whether they can move our booking to 8pm.' },
  { id: 'adam-business-sms', group: 'approval', mode: 'approval', expectedAction: 'send_adam_sms', message: 'Text the courier company and ask where my delivery is.' },
