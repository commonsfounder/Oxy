...
Current time: ${new Date().toLocaleString('en-GB')}`;
    ...
    const model = genAI.getGenerativeModel({ model: 'gemini-2.0-flash', systemInstruction: systemPrompt, tools: [{ googleSearch: {} }], generationConfig: { temperature: 1.5, topP: 1.0 } });
