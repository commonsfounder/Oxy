...
const ACTION_STATUS_LABELS = {
  ...
  ubereats_status: 'Opening Uber Eats',
  ubereats_set_address: 'Setting delivery address',
  ubereats_search: 'Searching Uber Eats',
  ubereats_get_restaurant: 'Opening restaurant',
  ubereats_add_to_cart: 'Adding to order',
  ubereats_view_cart: 'Reviewing cart',
  ubereats_clear_cart: 'Clearing cart',
  ubereats_checkout: 'Opening checkout',
  ubereats_track_order: 'Tracking order',
...
function buildAvailableActions(enabled) {
  const actionMap = {
    ...
    uber: ['book_uber'],
    ubereats: ['order_uber_eats', 'ubereats_status', 'ubereats_set_address', 'ubereats_search', 'ubereats_get_restaurant', 'ubereats_add_to_cart', 'ubereats_view_cart', 'ubereats_clear_cart', 'ubereats_checkout', 'ubereats_track_order'],
