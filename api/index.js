...
function displayPageHtml() {
  return [
    ...
    'const voiceMode=params.get("mode")==="voice"||localStorage.getItem("milgrain_display_mode")==="voice";',
    'if(params.has("mode"))localStorage.setItem("milgrain_display_mode",voiceMode?"voice":"text");',
